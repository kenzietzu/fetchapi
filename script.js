const position = ['MSFT', 'AAPL', 'NVDA', 'GOOG', 'U', 'TSM', 'QQQ', 'TSLA'];
let price = [];
let date = [];
...
function buildData() {
    ...
    document.getElementById('stock8').textContent = position[5];
    document.getElementById('price8').textContent = price[5];
